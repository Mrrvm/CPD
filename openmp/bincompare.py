...
executables = [
    "./kuduro-adapta", "./kuduro-bfs", "./kuduro-reborn", "./kuduro-subqueues",
    "./kuduro-tasks"
]
files = [
...
for exe in executables:
    ...
    for filename in files:
        if (filename == "./testfiles/25x25.txt") & (
                (exe == "./kuduro-bfs") | (exe == "./kuduro-subqueues")):
            continue
        signal.alarm(1 * 60)
        try:
...
layout = go.Layout(
    title='Kuduro - Implementation/Execution Time 4 Threads',
    xaxis=dict(
        title='File',

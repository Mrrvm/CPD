...
uint_fast8_t get_candidate(int ptr) { return to_solve->plays[ptr]; }

void set_candidate(int ptr, int val) { to_solve->plays[ptr] = val; }

void increment_candidate(int ptr) { to_solve->plays[ptr]++; }
